...
end entity Nios_Sys_A1;


architecture Structure of Nios_Sys_A1 is
...
begin 
	u0 : component Nios_System_2A
		port map (
			...
			hex0_pio_external_connection_export => HEX0, -- hex0_pio_external_connection.export
			hex1_pio_external_connection_export => HEX1, -- hex1_pio_external_connection.export
			hex2_pio_external_connection_export => HEX4, -- hex2_pio_external_connection.export
			hex3_pio_external_connection_export => HEX5  -- hex3_pio_external_connection.export
		);
