...
# ACDS 18.1 625 win32 2026.06.07.22:35:39
...
# ----------------------------------------
# If system_pll_10 is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/system_pll_10.vho"
fi
